...
labeling_function = lambda x: 1 if x['rating'] > 4 else 0 # TODO: Define your labeling function here.
...
class BaselineChallenge(FlowSpec):
    ...
    data = IncludeFile('data', default='women-clothing.csv')
    ...
    def baseline(self):
        ...
        predictions = [1]*self.valdf.shape[0] # TODO: predict the majority class
